 ...
 */
namespace Managemarketplace\Gridpartmanage\Model;
...
class Template extends \Magento\Framework\Model\AbstractModel
{
	...
	const CACHE_TAG = 'custom_adbanner';
   ...
   const STATUS_DISABLED = 2;
    ...
    {
        $this->_init('Managemarketplace\Gridpartmanage\Model\ResourceModel\Template');
    }
