...
namespace Servicesbanner\Gridpart3\Setup;
...
class InstallSchema implements InstallSchemaInterface {
    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context) {
        ...
        $installer->startSetup();
            ...
            $installer->getTable('gridpart2_servicesbanner'))
                ->addColumn(
                        'gridpart2servicesbanner_id', \Magento\Framework\DB\Ddl\Table::TYPE_INTEGER, null, array('identity' => true, 'unsigned' => true, 'nullable' => false, 'primary' => true), 'Code ID'
                )->addColumn(
