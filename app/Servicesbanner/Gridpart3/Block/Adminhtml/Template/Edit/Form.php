 ...
 */
namespace Servicesbanner\Gridpart3\Block\Adminhtml\Template\Edit;

class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
    /**
     * @var \Servicesbanner\Gridpart3\Helper\Option
     */
    ...
    public function __construct(
        ...
        \Servicesbanner\Gridpart3\Helper\Option $optionData,
        array $data = []
    ) {
    ...
    {
        return $this->_coreRegistry->registry('_gridpart3_template');
    }
    ...
    protected function _prepareForm()
    {
       ...
       // echo $model->getSss();
        ...
        $fieldset->addType('background', 'Servicesbanner\Gridpart3\Block\Adminhtml\Template\Helper\Background');
