 ...
 */
namespace Addsubscriptionplans\Gridpartsubscriptionplans\Model;
...
class Template extends \Magento\Framework\Model\AbstractModel
{
	...
	const CACHE_TAG = 'custom_addsubscriptionplans';
   ...
   const STATUS_DISABLED = 2;
    ...
    {
        $this->_init('Addsubscriptionplans\Gridpartsubscriptionplans\Model\ResourceModel\Template');
    }
