...
class Save extends \Productbanner\Gridpart4\Controller\Adminhtml\Template
{
    /**
    ...
    public function execute()
    {
        ...
        if (!$request->isPost()) {
         ...
         $template = $this->_objectManager->create('Productbanner\Gridpart4\Model\Template');
        $id = (int)$request->getParam('id');
            ...
            $data = $request->getParams();
             ...
             if (isset($_FILES['background']) && $_FILES['background']['name'] != '') {
                try {
                    ...
                    $uploader = $this->_objectManager->get('Productbanner\Gridpart4\Model\Theme\Upload');
                    $backgroundModel = $this->_objectManager->get('Productbanner\Gridpart4\Model\Theme\Background');
