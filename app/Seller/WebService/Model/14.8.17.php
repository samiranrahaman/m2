  ...
  /**
    ...
    public function getproductlistofseller($sellerid) {	
      if(empty($sellerid) || !isset($sellerid) || $sellerid == ""){
		...
		//$result[]=array('status'=>array("code"=>"1","message"=>"sucess","seller_id"=>"2"),'offersbanners'=>array(array('id'=>1,'img'=>'"http://159.203.151.92/banner-image.png'),array('id'=>2,'img'=>'"http://159.203.151.92/141961_20160310_HPOasis_A1.jpg')));
		...
		foreach($result3 as $data)
		{
			     //echo $data['mageproduct_id']; 
				   ...
				   $currentproduct = $objectManager->create('Magento\Catalog\Model\Product')->load($productId);
					...
					$result4[]['thumbnail']='http://159.203.151.92/pub/media/catalog/product'.$currentproduct->getthumbnail(); */
				   ...
				   if($ratingSummary=='')
				{
				   ...
				   //print_r($ratingSummary);
					...
					//$result4[]=array("id"=>$currentproduct->getId()); 
     ...
     public function getofferbanner($sellerid)
	{
		...
		if(!empty($result2))
		{
					...
					if($imgname!='')
					{
						//$result[]=array('status'=>array("code"=>"1","message"=>"sucess","seller_id"=>$sellerid),'offersbanners'=>array(array('id'=>1,'img'=>'http://159.203.151.92/pub/media/avatar/'.$imgname.'')));
 ...
 */
    ...
    public function getreview($product_id)
	{
		...
		//echo "<pre>"; print_r($result_result);
		 ...
		 {
			  //$result[]=array('status'=>array("code"=>"0","message"=>"error"));  
			   $result[]=array('status'=>array("code"=>"1","message"=>"Success"),'review'=>"No result found!"); 
		 }
