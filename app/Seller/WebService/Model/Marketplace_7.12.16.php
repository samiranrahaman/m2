								...
								/* if($year>=date('Y'))
								{
									   ...
									   //$calendar.= '<a id="next" onclick="nextfunction();">next</a>';
											...
											$calendar.='<tr  style="background-color: black;"> 
														 <th style="text-align: center;cursor: pointer;"> <a id="prev" onclick="prevfunction();" data-goto="2017-01-01" class="page-left"><i style="font: normal normal normal 32px/1 FontAwesome;" class="fa fa fa-arrow-left" aria-hidden="true"></i></a>				</th>
														  <th style="text-align: center" colspan="5">
														  <span class="calendarSavingState" style="display: none;">
														  <i class="fa fa-refresh fa-spin" aria-hidden="true"></i>
														   </span>
														   <span class="monthName">'.$monthchar.' '.$year.'</span>
														 </th>
														  <th style="text-align: center;cursor: pointer;"> <a id="next" onclick="nextfunction();" data-goto="2017-01-01" class="page-right"><i style="font: normal normal normal 32px/1 FontAwesome;" class="fa fa-arrow-right" aria-hidden="true"></i></a>				</th>
														  </tr>';
											/* table headings */
