                        ...
                        if ($_link->getSampleFile() || $_link->getSampleUrl()) {
                            ...
                            if ($link->getId()) {
                                if ($link->getSampleType() == \Magento\Downloadable\Helper\Download::LINK_TYPE_URL) {
                                    ...
                                    $eachLink["mime_type"] = mime_content_type($this->_helperCatalog->getBasePath('media').'/'.$sampleLinkFilePath);
                    ...
                    foreach ($_linkSamples as $_linkSample) {
                        ...
                        if ($sample->getId()) {
                            if ($sample->getSampleType() ==\Magento\Downloadable\Helper\Download::LINK_TYPE_URL
                                ...
                                $eachSample["mime_type"] = mime_content_type($this->_helperCatalog->getBasePath('media').'/'.$sampleFilePath);
